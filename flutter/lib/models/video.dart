...
class ShortVideo extends Video {
  ...
  factory ShortVideo.fromJson(Map<String, dynamic> json) {
    return ShortVideo(
      ...
      categoryId: json['category_id'] != null ? Video._toInt(json['category_id']) : (json['short_category_id'] != null ? Video._toInt(json['short_category_id']) : null),
      categoryName: json['category_name'],
      creatorId: json['creator_id'] != null ? Video._toInt(json['creator_id']) : (json['user_id'] != null ? Video._toInt(json['user_id']) : null),
      creatorName: json['creator_name'] ?? json['username'],
      creatorAvatar: json['creator_avatar'] ?? json['avatar'],
      status: json['status'] ?? 'active',
